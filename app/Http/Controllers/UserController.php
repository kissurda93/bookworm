...
{
    public function getUser(int $id): InertiaResponse
    {
    ...
    public function getUsers(string $query = null): InertiaResponse
    {
        if ($query) {
    ...
    public function newPasswordForm(string $token): InertiaResponse
    {
